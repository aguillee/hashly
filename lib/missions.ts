...
export const MISSION_DEFINITIONS: MissionDefinition[] = [
  ...
  },
  {
    ...
    description: "Vote on all 3 sentiment categories (NFT, Network, HBAR)",
    pointsReward: 25,
    type: "DAILY",
    requirement: 3,
    icon: "activity",
  ...
  // Sentiment Achievements
  {
    id: "first_sentiment_vote",
    name: "Sentiment Pioneer",
  ...
  {
    id: "sentiment_week_streak",
    name: "Sentiment Analyst",
    description: "Vote on sentiment 7 days in a row",
    pointsReward: 100,
    type: "ACHIEVEMENT",
    requirement: 7,
    icon: "flame",
  ...
  {
    id: "sentiment_votes_30",
    name: "Market Watcher",
    description: "Vote on sentiment for 30 different days",
    pointsReward: 300,
    type: "ACHIEVEMENT",
    requirement: 30,
    icon: "activity",
  ...
  {
    id: "sentiment_votes_100",
    name: "Sentiment Expert",
    description: "Vote on sentiment for 100 different days",
    pointsReward: 1000,
    type: "ACHIEVEMENT",
    requirement: 100,
    icon: "trophy",
